...
class Repository {
  ...
  getAll(params = null) {
    ...
    if(params)
    {
      ...
      {
        objectsList.forEach((image) => {
          let stringTitleDescription = (image.Title + image.Description).toLowerCase();
          ...
          keywords.forEach((keyword) =>{
            ...
            {
              objectsListFiltered.push(image);
            }
          });
        });
        objectsList = objectsListFiltered;
